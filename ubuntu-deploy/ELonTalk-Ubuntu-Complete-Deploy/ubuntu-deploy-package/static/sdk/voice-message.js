...
exports.VoiceMessageRenderer = void 0;
// SDK 语音消息UI渲染器
const voice_player_1 = require("./voice-player");
class VoiceMessageRenderer {
    constructor(options) {
        this.options = options;
        this.isPlaying = false;
        this.duration = 0;
        this.currentProgress = 0;
        this.player = new voice_player_1.VoicePlayer();
    ...
    setupEventListeners() {
        const playBtn = this.element.querySelector('.voice-message__play-btn');
        const downloadBtn = this.element.querySelector('.voice-message__download-btn');
        const waveform = this.element.querySelector('.voice-message__waveform');
        playBtn === null || playBtn === void 0 ? void 0 : playBtn.addEventListener('click', () => this.togglePlay());
        downloadBtn === null || downloadBtn === void 0 ? void 0 : downloadBtn.addEventListener('click', () => { var _a, _b; return (_b = (_a = this.options).onDownload) === null || _b === void 0 ? void 0 : _b.call(_a); });
        waveform === null || waveform === void 0 ? void 0 : waveform.addEventListener('click', (e) => this.handleSeek(e));
    ...
    updatePlayButton() {
        const playIcon = this.element.querySelector('.voice-message__play-icon');
        const pauseIcon = this.element.querySelector('.voice-message__pause-icon');
        if (this.isPlaying) {
    ...
    updateProgress(progress) {
        ...
        // 更新时间显示
        const timeEl = this.element.querySelector('.voice-message__time');
...
exports.VoiceMessageRenderer = VoiceMessageRenderer;
