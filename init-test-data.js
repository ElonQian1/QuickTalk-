...
async function initCompleteTestData() {
    ...
    // database.shops.clear();
    // database.userShops.clear();
    ...
    const adminUser = {
        id: adminId,
        username: 'admin',
        password: database.hashPassword('admin123'),
    ...
    database.users.set(adminId, adminUser);
    ...
    const reviewerUser = {
        id: reviewerId,
        username: 'reviewer',
        password: database.hashPassword('reviewer123'),
    ...
    database.users.set(reviewerId, reviewerUser);
    ...
    const shopOwnerUser = {
        id: shopOwnerId,
        username: 'shop_owner',
        password: database.hashPassword('123456'),
    ...
    database.users.set(shopOwnerId, shopOwnerUser);
    ...
    database.users.set(shopOwner2Id, shopOwner2User);
    ...
    shops.forEach((shopData, index) => {
        ...
        database.shops.set(shopId, shop);
    ...
    database.userShops.set(shopOwnerId, owner1Shops.map(shop => ({
        shopId: shop.id,
        role: 'owner',
        userRole: 'owner',
    ...
    database.userShops.set(shopOwner2Id, owner2Shops.map(shop => ({
        shopId: shop.id,
        role: 'owner',
        userRole: 'owner',
        permissions: ['manage_staff', 'view_chats', 'handle_chats', 'manage_shop', 'view_analytics'],
    ...
    employees.forEach((emp, index) => {
        ...
        database.users.set(empId, employee);
    ...
    return {
        ...
        shops: database.shops.size,
        userShops: database.userShops.size,
