...
class ImageViewer {
    ...
    bindGestureEvents(container) {
        ...
        const onPointerDown = (e) => {
            var _a;
            (_a = container.setPointerCapture) === null || _a === void 0 ? void 0 : _a.call(container, e.pointerId);
        ...
        container.addEventListener('dblclick', onDblClick, { passive: false });
        container.addEventListener('pointerdown', onQuickTap, { passive: false });
        (_a = this.overlay) === null || _a === void 0 ? void 0 : _a.addEventListener('wheel', onWheel, { passive: false });
        // 存在 overlay 变化时的清理引用
        container.__qtHandlers = { onPointerDown, onPointerMove, onPointerUp, onDblClick, onQuickTap, onWheel };
    }
    unbindGestureEvents(container) {
        var _a;
        const h = container.__qtHandlers;
        if (!h)
            return;
        try {
            ...
            (_a = this.overlay) === null || _a === void 0 ? void 0 : _a.removeEventListener('wheel', h.onWheel);
        }
        catch (_b) { }
        container.__qtHandlers = null;
    }
    zoomAt(center, deltaScale, absolute = false) {
